package at.atvgstudios.gitlab.app.DPendulum
...
class DPendulum : PApplet() {
    ...
    /**
     * Set window size 900x600; calc center position
     */
    ...
    /**
     * Calculate next step and Draw to screen
     */
    override fun draw() {
        ...
        val a1A = (num1 + num2 + num3 * num4) / den
        ...
        val a2A = (num1 * (num2 + num3 + num4)) / den
